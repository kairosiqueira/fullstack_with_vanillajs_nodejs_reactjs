...
export default class App extends Component {
    ...
    handleChangeText = (newText) => {
        ...
        this.setState({
            ...
            onlyVowelsText    : textTransformer.toOnlyVowels(newText),
            onlyConsonantsText: textTransformer.toOnlyConsonants(newText),
    ...
    render() {
        ...
        const { 
            ...
            onlyVowelsText, 
            onlyConsonantsText, 
            toVarText } = this.state;

        return (
            <div className="container">
                <div className="row">
                    <h3 className="center col s12">React Text Transformation</h3>
                    <UserInput 
                        userInput={userInput} 
